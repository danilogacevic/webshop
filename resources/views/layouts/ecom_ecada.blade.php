                    ...
                    <div class="row">
                        ...
                        <div data-filter="web" class="grid-item col-md-4 col-sm-6 col-xs-12">
                            <div class="category-product">
                                <img src="img/shop/category/img_360x500.png" class="img-responsive" alt="" />
                        ...
                        <div data-filter="graphic" class="grid-item col-md-4 col-sm-6 col-xs-12">
                            <div class="category-product">
                                <img src="img/shop/category/img_360x235.png" class="img-responsive" alt="" />
                                <div class="option-product">
                                    <h4 class="title">
                                        Hat <small>/ Clotching</small>
                                    </h4>
                                    <p>Fresh design</p>
                                </div>
                                <a href="#"></a>
                        ...
                        <div data-filter="app" class="grid-item col-md-4 col-sm-6 col-xs-12">
                            <div class="category-product">
                                ...
                                <div class="option-product">
                                    <h4 class="title">
                                        Clothes <small>/ Clotching</small>
                                    </h4>
                                    <p>New models on 2016</p>
                                </div>
                                <a href="#"></a>
                            </div>
                        </div>
